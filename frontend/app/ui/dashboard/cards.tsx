...
return (
    ...
    <>
      ...
      <Card3
        ...
        type="total"
      />
        <Card4 title="Transfers" value={transfers} type="transfers" />
    </>
  );
}
...
export function Card2({
    ...
    return (
        <div className={`rounded-xl bg-green-300 p-2 shadow-sm`}>
            <div className="flex p-4">
                {Icon ? <Icon className="h-5 w-5 text-green-700" /> : null}
                <h3 className="ml-2 text-sm font-medium">{title}</h3>
            </div>
...
export function Card4({
    ...
    return (
        <div className={`rounded-xl bg-orange-300 p-2 shadow-sm`}>
            <div className="flex p-4">
                {Icon ? <Icon className="h-5 w-5 text-green-700" /> : null}
                <h3 className="ml-2 text-sm font-medium">{title}</h3>
            </div>
